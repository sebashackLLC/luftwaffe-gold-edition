...
public class jlp
{
    ...
    public void play() throws JavaLayerException {
        try {
            ...
            throw new JavaLayerException("Problem playing file " + this.fFilename, (Throwable)ex);
        }
        catch (Exception ex2) {
            throw new JavaLayerException("Problem playing file " + this.fFilename, (Throwable)ex2);
        }
    }
