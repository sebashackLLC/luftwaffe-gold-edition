...
public class WaveFile extends RiffFile
{
    ...
    public WaveFile() {
        ...
        this.num_samples = 0;
        this.pcm_data = new RiffFile.RiffChunkHeader((RiffFile)this);
    ...
    public int WriteData(final short[] data, final int numData) {
        ...
        final RiffFile.RiffChunkHeader pcm_data = this.pcm_data;
    ...
    class WaveFormat_Chunk
    {
        ...
        public WaveFormat_Chunk() {
            this.header = new RiffFile.RiffChunkHeader((RiffFile)WaveFile.this);
