...
import me.alpha432.oyvey.impl.command.commands.*;
...
public class CommandManager extends Feature
{
    ...
    public CommandManager() {
        ...
        this.commands.add((Command)new BackupCommand());
        this.commands.add((Command)new ColorSyncCommand());
