...
public class ColorManager
{
    ...
    public int getColorWithAlpha(final int alpha) {
        if (me.alpha432.oyvey.impl.features.modules.client.Color.getInstance().rainbow.getValue()) {
            return ColorUtil.rainbow(Component.counter1[0] * (int)me.alpha432.oyvey.impl.features.modules.client.Color.getInstance().rainbowHue.getValue()).getRGB();
        }
