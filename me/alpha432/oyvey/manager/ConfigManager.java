...
public class ConfigManager implements Util
{
    ...
    public static void setValueFromJson(final Feature feature, final Setting setting, final JsonElement element) {
        ...
        switch (type) {
            ...
            case "String": {
                setting.setValue((Object)element.getAsString());
            }
            case "Bind": {
            ...
            case "ColorSetting": {
                try {
                    setting.setValue((Object)ColorSetting.fromString(element.getAsString()));
                }
                catch (Exception ex) {}
            }
            case "Enum": {
    ...
    public JsonObject writeSettings(final Feature feature) {
        ...
        for (final Setting setting : feature.getSettings()) {
            if (setting.isEnumSetting()) {
                ...
                object.addProperty(setting.getName(), (String)setting.getValue());
            }
            else {
                try {
