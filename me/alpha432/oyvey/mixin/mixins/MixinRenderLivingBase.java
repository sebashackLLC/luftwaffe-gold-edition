            ...
            try {
                ...
                if (this.field_188301_f) {
                    ...
                    if (Wireframe.getINSTANCE().isOn() && (boolean)Wireframe.getINSTANCE().players.getValue() && entity instanceof EntityPlayer && ((Wireframe.RenderMode)Wireframe.getINSTANCE().mode.getValue()).equals((Object)Wireframe.RenderMode.SOLID)) {
                        ...
                        this.red = mainColor.getRed() / 255.0f;
                        this.green = mainColor.getGreen() / 255.0f;
                        this.blue = mainColor.getBlue() / 255.0f;
                        GlStateManager.func_179094_E();
                        ...
                        if (OyVey.friendManager.isFriend(entity.func_70005_c_()) || entity == Minecraft.func_71410_x().field_71439_g) {
                            ...
                            GL11.glColor4f(((boolean)Color.getInstance().rainbow.getValue()) ? (ColorUtil.rainbow((int)Color.getInstance().rainbowHue.getValue()).getRed() / 255.0f) : this.red, ((boolean)Color.getInstance().rainbow.getValue()) ? (ColorUtil.rainbow((int)Color.getInstance().rainbowHue.getValue()).getGreen() / 255.0f) : this.green, ((boolean)Color.getInstance().rainbow.getValue()) ? (ColorUtil.rainbow((int)Color.getInstance().rainbowHue.getValue()).getBlue() / 255.0f) : this.blue, (float)Wireframe.getINSTANCE().alpha.getValue() / 255.0f);
                        }
                        this.func_77036_a(entity, f9, f8, f6, f3, f5, f7);
                        GL11.glDisable(2896);
                        GL11.glEnable(2929);
                    ...
                    if (Wireframe.getINSTANCE().isOn() && (boolean)Wireframe.getINSTANCE().players.getValue() && entity instanceof EntityPlayer && ((Wireframe.RenderMode)Wireframe.getINSTANCE().mode.getValue()).equals((Object)Wireframe.RenderMode.WIREFRAME)) {
                        final ColorSetting mainColor2 = (ColorSetting)Color.getInstance().mainColor.getValue();
                        this.red = mainColor2.getRed() / 255.0f;
                        this.green = mainColor2.getGreen() / 255.0f;
                        this.blue = mainColor2.getBlue() / 255.0f;
                        GlStateManager.func_179094_E();
                        GL11.glPushAttrib(1048575);
