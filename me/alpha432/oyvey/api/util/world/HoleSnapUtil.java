...
public class HoleSnapUtil
{
    ...
    public static Hole getTargetHoleVec3D(final double targetRange) {
        return getHoles(targetRange, getPlayerPos(), true).stream().filter(hole -> Util.mc.field_71439_g.func_174791_d().func_72436_e(new Vec3d(hole.pos1.func_177958_n() + 0.5, Util.mc.field_71439_g.field_70163_u, hole.pos1.func_177952_p() + 0.5)) <= targetRange * targetRange).min(Comparator.comparingDouble(hole -> Util.mc.field_71439_g.func_174791_d().func_72436_e(new Vec3d(hole.pos1.func_177958_n() + 0.5, Util.mc.field_71439_g.field_70163_u, hole.pos1.func_177952_p() + 0.5)))).orElse(null);
    }
    
    public static boolean isHole(final BlockPos pos) {
        int amount = 0;
        for (final BlockPos p : HoleSnapUtil.holeOffsets) {
            if (!Util.mc.field_71441_e.func_180495_p(pos.func_177971_a((Vec3i)p)).func_185904_a().func_76230_c()) {
                ++amount;
            }
        }
        return amount == 5;
    ...
    public static boolean isObsidian(final BlockPos pos) {
        ...
        return block == Blocks.field_150343_Z || block == Blocks.field_150402_ci || block == Blocks.field_185771_cX;
    }
    ...
    public static boolean isSafeBlock(final BlockPos pos) {
        final Block block = Util.mc.field_71441_e.func_180495_p(pos).func_177230_c();
        return block == Blocks.field_150343_Z || block == Blocks.field_150357_h || block == Blocks.field_189879_dh;
    }
        ...
        for (final BlockPos pos : circle) {
            if (Util.mc.field_71441_e.func_180495_p(pos).func_177230_c() == Blocks.field_150350_a) {
                if (isObbyHole(pos)) {
                    ...
                    holes.add(new Hole(false, false, pos, null));
                }
                    ...
                    if (!doubles || (doubleHole = isDoubleHole(pos)) == null || Util.mc.field_71441_e.func_180495_p(doubleHole.pos1.func_177982_a(0, 1, 0)).func_177230_c() != Blocks.field_150350_a || Util.mc.field_71441_e.func_180495_p(doubleHole.pos2.func_177982_a(0, 1, 0)).func_177230_c() != Blocks.field_150350_a) {
                        continue;
                    }
    ...
    static {
        ...
        TERRAIN_BLOCKS = new Block[] { Blocks.field_150348_b, Blocks.field_150347_e, Blocks.field_150341_Y, Blocks.field_150322_A, Blocks.field_150344_f, Blocks.field_150364_r, Blocks.field_150363_s, (Block)Blocks.field_150354_m, Blocks.field_150351_n, Blocks.field_150352_o, Blocks.field_150366_p, Blocks.field_150365_q };
    }
