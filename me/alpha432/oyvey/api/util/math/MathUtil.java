...
public class MathUtil implements Util
{
    ...
    public static double getDistance(final Entity entity) {
        final double x = MathUtil.mc.field_71439_g.field_70165_t - entity.field_70165_t;
        final double y = MathUtil.mc.field_71439_g.field_70163_u - entity.field_70163_u;
        final double z = MathUtil.mc.field_71439_g.field_70161_v - entity.field_70161_v;
        return MathHelper.func_76133_a(x * x + y * y + z * z);
    }
    ...
    public static double distanceTo(final BlockPos blockPos) {
        return distanceTo(blockPos.func_177958_n(), blockPos.func_177956_o(), blockPos.func_177952_p());
    }
    
    public static double distanceTo(final double x, final double y, final double z) {
        if (MathUtil.mc.field_71439_g == null) {
            return 0.0;
        }
        final float f = (float)(MathUtil.mc.field_71439_g.field_70165_t - x);
        final float g = (float)(MathUtil.mc.field_71439_g.field_70163_u - y);
        final float h = (float)(MathUtil.mc.field_71439_g.field_70161_v - z);
        return MathHelper.func_76129_c(f * f + g * g + h * h);
    }
