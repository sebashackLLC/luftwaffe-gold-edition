...
public class PlayerUtil implements Util
{
    ...
    public static double[] forward(final double speed) {
        float forward = PlayerUtil.mc.field_71439_g.field_71158_b.field_192832_b;
        float side = PlayerUtil.mc.field_71439_g.field_71158_b.field_78902_a;
        float yaw = PlayerUtil.mc.field_71439_g.field_70126_B + (PlayerUtil.mc.field_71439_g.field_70177_z - PlayerUtil.mc.field_71439_g.field_70126_B) * PlayerUtil.mc.func_184121_ak();
        if (forward != 0.0f) {
            if (side > 0.0f) {
    ...
    public static double[] stepOffset(final double height) {
        if (height == 0.75) {
        ...
        return (double[])((height == 2.5) ? new double[] { 0.425, 0.821, 0.699, 0.599, 1.022, 1.372, 1.652, 1.869, 2.019, 1.907 } : null);
    }
    ...
    public static BlockPos getPlayerPos(final Entity player) {
