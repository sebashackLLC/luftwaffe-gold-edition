...
public class EntityUtil implements Util
{
    ...
    public static boolean isOnGround() {
        if (EntityUtil.mc.field_71439_g == null || EntityUtil.mc.field_71441_e == null) {
            return false;
        }
        if (!EntityUtil.mc.field_71439_g.field_70122_E) {
            return false;
        }
        final BlockPos pos = new BlockPos(EntityUtil.mc.field_71439_g.field_70165_t, EntityUtil.mc.field_71439_g.field_70163_u - 0.1, EntityUtil.mc.field_71439_g.field_70161_v);
        return !(EntityUtil.mc.field_71441_e.func_180495_p(pos).func_177230_c() instanceof BlockAir);
    }
    
    public static void resetTimer() {
        EntityUtil.mc.field_71428_T.field_194149_e = 50.0f;
    }
    
    public static void setTimer(final float speed) {
        EntityUtil.mc.field_71428_T.field_194149_e = 50.0f / speed;
    }
    ...
    public static Vec3d getEntityPosVec(final Entity entity, final int ticks) {
        return entity.func_174791_d().func_178787_e(getMotionVec(entity, ticks));
    }
    
    public static Vec3d getMotionVec(final Entity entity, final int ticks) {
        final double dX = entity.field_70165_t - entity.field_70169_q;
        final double dZ = entity.field_70161_v - entity.field_70166_s;
        double entityMotionPosX = 0.0;
        double entityMotionPosZ = 0.0;
        for (int i = 1; i <= ticks && EntityUtil.mc.field_71441_e.func_180495_p(new BlockPos(entity.field_70165_t + dX * i, entity.field_70163_u, entity.field_70161_v + dZ * i)).func_177230_c() instanceof BlockAir; ++i) {
    ...
    public static boolean isBurrow(final EntityPlayer target) {
        if (EntityUtil.mc.field_71441_e != null && EntityUtil.mc.field_71439_g != null && target != null) {
            final BlockPos blockPos = new BlockPos(target.field_70165_t, target.field_70163_u, target.field_70161_v);
            return EntityUtil.mc.field_71441_e.func_180495_p(blockPos).func_177230_c().equals(Blocks.field_150343_Z) || EntityUtil.mc.field_71441_e.func_180495_p(blockPos).func_177230_c().equals(Blocks.field_150477_bB);
        }
        return false;
    }
    
    public static BlockPos getOtherPlayerPos(final EntityPlayer player) {
        final double decimalPoint = player.field_70163_u - Math.floor(player.field_70163_u);
        return new BlockPos(player.field_70165_t, (decimalPoint > 0.8) ? (Math.floor(player.field_70163_u) + 1.0) : Math.floor(player.field_70163_u), player.field_70161_v);
    }
    ...
    public static double getDefaultMoveSpeed() {
        ...
        if (EntityUtil.mc.field_71439_g != null && EntityUtil.mc.field_71439_g.func_70644_a(Potion.func_188412_a(1))) {
            final int amplifier = EntityUtil.mc.field_71439_g.func_70660_b(Potion.func_188412_a(1)).func_76458_c();
    ...
    public static void phaseSpeed(final MoveEvent event, final double speed) {
        if (isMoving()) {
            float boost = 0.0f;
            if (!EntityUtil.mc.field_71439_g.field_70123_F && Phase.getInstance().isPhasing() && EntityUtil.mc.field_71439_g.field_70122_E) {
                boost = MathUtil.random.nextFloat() * 0.2f + 0.1f;
            }
            final double[] strafe = strafe(speed + boost);
            event.setX(strafe[0]);
            event.setZ(strafe[1]);
        }
        else {
    ...
    public static double getStrictBaseSpeed(final Double baseSpeed) {
        double maxModifier = baseSpeed;
        if (EntityUtil.mc.field_71439_g.func_70644_a((Potion)Objects.requireNonNull(Potion.func_188412_a(1)))) {
            maxModifier *= 1.0 + 0.1 * (Objects.requireNonNull(EntityUtil.mc.field_71439_g.func_70660_b((Potion)Objects.requireNonNull(Potion.func_188412_a(1)))).func_76458_c() + 1);
        }
        return maxModifier;
    }
    
    public static double[] strafe(final double speed) {
        return strafe((Entity)EntityUtil.mc.field_71439_g, speed);
    }
    
    public static double[] strafe(final Entity entity, final double speed) {
        return strafe(entity, EntityUtil.mc.field_71439_g.field_71158_b, speed);
    }
    ...
    public static double[] strafe(final Entity entity, final MovementInput movementInput, final double speed) {
        ...
        float rotationYaw = entity.field_70126_B + (entity.field_70177_z - entity.field_70126_B) * EntityUtil.mc.func_184121_ak();
        if (moveForward != 0.0f) {
            if (moveStrafe > 0.0f) {
    ...
    public static boolean isEating() {
        return (EntityUtil.mc.field_71439_g.func_184587_cr() && EntityUtil.mc.field_71439_g.func_184607_cu().func_77973_b() instanceof ItemFood) || (EntityUtil.mc.field_71439_g.func_184614_ca().func_77973_b() instanceof ItemFood && Mouse.isButtonDown(1));
    }
    ...
    public static float getXYZYaw(final double n, final double n2, final double n3) {
        return MathUtil.calcAngle(EntityUtil.mc.field_71439_g.func_174824_e(EntityUtil.mc.func_184121_ak()), new Vec3d(n, n2, n3))[0];
    }
    
    public static float getXYZPitch(final double n, final double n2, final double n3) {
        return MathUtil.calcAngle(EntityUtil.mc.field_71439_g.func_174824_e(EntityUtil.mc.func_184121_ak()), new Vec3d(n, n2, n3))[1];
    }
    
    public static void faceYawAndPitch(final float yaw, final float pitch) {
        sendPlayerRot(yaw, pitch, EntityUtil.mc.field_71439_g.field_70122_E);
    }
    
    public static void sendPlayerRot(final float n, final float n2, final boolean b) {
        EntityUtil.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketPlayer.Rotation(n, n2, b));
    }
