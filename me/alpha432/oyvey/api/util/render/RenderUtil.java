...
public class RenderUtil implements Util
{
    ...
    public static void drawTexturedRect(final int x, final int y, final int textureX, final int textureY, final int width, final int height, final int zLevel) {
        ...
        BufferBuilder2.func_181662_b((double)(x + 0), (double)(y + height), (double)zLevel).func_187315_a((double)((textureX + 0) * 0.00390625f), (double)((textureY + height) * 0.00390625f)).func_181675_d();
        ...
        BufferBuilder2.func_181662_b((double)(x + width), (double)(y + 0), (double)zLevel).func_187315_a((double)((textureX + width) * 0.00390625f), (double)((textureY + 0) * 0.00390625f)).func_181675_d();
        BufferBuilder2.func_181662_b((double)(x + 0), (double)(y + 0), (double)zLevel).func_187315_a((double)((textureX + 0) * 0.00390625f), (double)((textureY + 0) * 0.00390625f)).func_181675_d();
        tessellator.func_78381_a();
    }
    
    public static void drawGradientRect(final int x1, final int y1, final int x2, final int y2, final int color1, final int color2) {
    ...
    public static void drawText(final BlockPos pos, final String text) {
        ...
        Render2DMethods.drawNameTagRect((float)(-width - 2), (float)(-RenderUtil.mc.field_71466_p.field_78288_b), width + 2.0f, 1.5f, bgColor, bgColor, 1.4f);
    ...
    public static void drawRect(final float x, final float y, final float w, final float h, final long color) {
        final float alpha = (color >> 24 & 0xFFL) / 255.0f;
        final float red = (color >> 16 & 0xFFL) / 255.0f;
        final float green = (color >> 8 & 0xFFL) / 255.0f;
        final float blue = (color & 0xFFL) / 255.0f;
        final Tessellator tessellator = Tessellator.func_178181_a();
        final BufferBuilder bufferbuilder = tessellator.func_178180_c();
        GlStateManager.func_179147_l();
        GlStateManager.func_179090_x();
    ...
    public static void drawGradientRect(final float x, final float y, final float w, final float h, final long color, final long color2, final boolean vertical) {
        final float alpha = (color >> 24 & 0xFFL) / 255.0f;
        final float red = (color >> 16 & 0xFFL) / 255.0f;
        final float green = (color >> 8 & 0xFFL) / 255.0f;
        final float blue = (color & 0xFFL) / 255.0f;
        final float alpha2 = (color2 >> 24 & 0xFFL) / 255.0f;
        final float red2 = (color2 >> 16 & 0xFFL) / 255.0f;
        final float green2 = (color2 >> 8 & 0xFFL) / 255.0f;
        final float blue2 = (color2 & 0xFFL) / 255.0f;
        final Tessellator tessellator = Tessellator.func_178181_a();
        final BufferBuilder bufferbuilder = tessellator.func_178180_c();
        GlStateManager.func_179147_l();
        GlStateManager.func_179090_x();
        ...
        bufferbuilder.func_181668_a(7, DefaultVertexFormats.field_181706_f);
        if (vertical) {
            bufferbuilder.func_181662_b((double)x, (double)(y + h), 0.0).func_181666_a(red2, green2, blue2, alpha2).func_181675_d();
            bufferbuilder.func_181662_b((double)(x + w), (double)(y + h), 0.0).func_181666_a(red2, green2, blue2, alpha2).func_181675_d();
            bufferbuilder.func_181662_b((double)(x + w), (double)y, 0.0).func_181666_a(red, green, blue, alpha).func_181675_d();
            bufferbuilder.func_181662_b((double)x, (double)y, 0.0).func_181666_a(red, green, blue, alpha).func_181675_d();
        }
        else {
            bufferbuilder.func_181662_b((double)(x + w), (double)(y + h), 0.0).func_181666_a(red2, green2, blue2, alpha2).func_181675_d();
            bufferbuilder.func_181662_b((double)(x + w), (double)y, 0.0).func_181666_a(red2, green2, blue2, alpha2).func_181675_d();
            bufferbuilder.func_181662_b((double)x, (double)y, 0.0).func_181666_a(red, green, blue, alpha).func_181675_d();
            bufferbuilder.func_181662_b((double)x, (double)(y + h), 0.0).func_181666_a(red, green, blue, alpha).func_181675_d();
        }
        tessellator.func_78381_a();
        GlStateManager.func_179103_j(7424);
        GlStateManager.func_179141_d();
    ...
    public static void drawOutlineRect(final float x, final float y, final float width, final float height, final float lineWidth, final int color) {
        final float right = width;
        final float bottom = height;
        drawRect(x, y, right, y + lineWidth, color);
        drawRect(x, y + lineWidth, x + lineWidth, bottom - lineWidth, color);
        drawRect(right - lineWidth, y + lineWidth, right, bottom - lineWidth, color);
        drawRect(x + lineWidth, bottom - lineWidth, right - lineWidth, bottom, color);
    }
    ...
    public static void scissor(final float x, final float y, final float width, final float height) {
        ...
        final int scale = sr.func_78325_e();
        final int scissorWidth = (int)(width * scale);
        final int scissorHeight = (int)(height * scale);
        final int scissorX = (int)(x * scale);
        final int scissorY = (int)((sr.func_78328_b() - (y + height)) * scale);
        GL11.glScissor(scissorX, scissorY, scissorWidth, scissorHeight);
    }
    
    public static void drawCircle(final float x, final float y, final float radius, final int segments, final int color) {
        final float alpha = (color >> 24 & 0xFF) / 255.0f;
        final float red = (color >> 16 & 0xFF) / 255.0f;
        final float green = (color >> 8 & 0xFF) / 255.0f;
        final float blue = (color & 0xFF) / 255.0f;
    ...
    public static void drawOutlineCircle(final float x, final float y, final float radius, final int segments, final int color) {
        final float alpha = (color >> 24 & 0xFF) / 255.0f;
        final float red = (color >> 16 & 0xFF) / 255.0f;
        final float green = (color >> 8 & 0xFF) / 255.0f;
        final float blue = (color & 0xFF) / 255.0f;
    ...
    public static void renderThroughWalls(final boolean start) {
        if (start) {
            GL11.glEnable(32823);
            GlStateManager.func_179088_q();
            GlStateManager.func_179136_a(1.0f, -1.0E7f);
        }
        else {
