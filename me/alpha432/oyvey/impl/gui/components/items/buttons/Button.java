...
public class Button extends Item
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        RenderUtil.drawRect(this.x, this.y, this.x + this.width, this.y + this.height - 0.5f, this.getState() ? ((long)(this.isHovering(mouseX, mouseY) ? OyVey.colorManager.getColorWithAlpha(255) : OyVey.colorManager.getColorWithAlpha(mainColor.getAlpha()))) : ((long)(this.isHovering(mouseX, mouseY) ? -2007673515 : 290805077)));
