...
public class UnlimitedSlider extends Button
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        RenderUtil.drawRect(this.x, this.y, this.x + this.width + 7.4f, this.y + this.height - 0.5f, this.isHovering(mouseX, mouseY) ? ((long)OyVey.colorManager.getColorWithAlpha(255)) : ((long)OyVey.colorManager.getColorWithAlpha(mainColor.getAlpha())));
