...
package me.alpha432.oyvey.impl.gui.background;
...
public class CustomGuiScreen extends GuiScreen
{
    ...
    public void func_73864_a(final int mouseX, final int mouseY, final int mouseButton) {
        if (isHovered(this.x - OyVey.textManager.getStringWidth("Singleplayer") / 2, this.y + 20, OyVey.textManager.getStringWidth("Singleplayer"), OyVey.textManager.getFontHeight(), mouseX, mouseY)) {
            this.field_146297_k.func_147108_a((GuiScreen)new GuiWorldSelection((GuiScreen)this));
        }
        else if (isHovered(this.x - OyVey.textManager.getStringWidth("Multiplayer") / 2, this.y + 44, OyVey.textManager.getStringWidth("Multiplayer"), OyVey.textManager.getFontHeight(), mouseX, mouseY)) {
            this.field_146297_k.func_147108_a((GuiScreen)new GuiMultiplayer((GuiScreen)this));
        }
        else if (isHovered(this.x - OyVey.textManager.getStringWidth("Settings") / 2, this.y + 66, OyVey.textManager.getStringWidth("Settings"), OyVey.textManager.getFontHeight(), mouseX, mouseY)) {
            this.field_146297_k.func_147108_a((GuiScreen)new GuiOptions((GuiScreen)this, this.field_146297_k.field_71474_y));
        }
        else if (isHovered(this.x - OyVey.textManager.getStringWidth("Exit") / 2, this.y + 88, OyVey.textManager.getStringWidth("Exit"), OyVey.textManager.getFontHeight(), mouseX, mouseY)) {
    ...
    private static class TextButton extends GuiButton
    {
        ...
        public void func_191745_a(final Minecraft mc, final int mouseX, final int mouseY, final float partialTicks) {
            if (this.field_146125_m) {
                ...
                this.field_146123_n = (mouseX >= this.field_146128_h - OyVey.textManager.getStringWidth(this.field_146126_j) / 2.0f && mouseY >= this.field_146129_i && mouseX < this.field_146128_h + this.field_146120_f && mouseY < this.field_146129_i + this.field_146121_g);
                OyVey.textManager.drawStringWithShadow(this.field_146126_j, this.field_146128_h - OyVey.textManager.getStringWidth(this.field_146126_j) / 2.0f, (float)this.field_146129_i, Color.WHITE.getRGB());
                if (this.field_146123_n) {
                    RenderUtil.drawLine(this.field_146128_h - 1 - OyVey.textManager.getStringWidth(this.field_146126_j) / 2.0f, (float)(this.field_146129_i + 2 + OyVey.textManager.getFontHeight()), this.field_146128_h + OyVey.textManager.getStringWidth(this.field_146126_j) / 2.0f + 1.0f, (float)(this.field_146129_i + 2 + OyVey.textManager.getFontHeight()), 1.0f, Color.WHITE.getRGB());
                }
            }
        }
        
        public boolean func_146116_c(final Minecraft mc, final int mouseX, final int mouseY) {
            return this.field_146124_l && this.field_146125_m && mouseX >= this.field_146128_h - OyVey.textManager.getStringWidth(this.field_146126_j) / 2.0f && mouseY >= this.field_146129_i && mouseX < this.field_146128_h + this.field_146120_f && mouseY < this.field_146129_i + this.field_146121_g;
        }
    }
}
