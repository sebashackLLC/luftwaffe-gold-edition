...
public final class Native implements Version
{
    ...
    public static void register(final Class<?> cls, final NativeLibrary lib) {
        ...
        for (int i = 0; i < handles.length; ++i) {
            ...
            for (int t = 0; t < ptypes.length; ++t) {
                ...
                final int conversionType = getConversion(type, mapper);
    ...
    public static void main(final String[] args) {
        ...
        final String DEFAULT_VERSION = "4.4.0";
        final String DEFAULT_BUILD = "4.4.0 (package information missing)";
        ...
        String version = (pkg != null) ? pkg.getSpecificationVersion() : "4.4.0";
        if (version == null) {
            version = "4.4.0";
        }
        title = title + " API Version " + version;
        System.out.println(title);
        version = ((pkg != null) ? pkg.getImplementationVersion() : "4.4.0 (package information missing)");
        if (version == null) {
