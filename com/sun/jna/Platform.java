...
public final class Platform
{
    ...
    static String getCanonicalArchitecture(String arch, final boolean softfloat) {
    ...
    static String getNativeLibraryResourcePrefix(final int osType, final String arch, final String name) {
        return getNativeLibraryResourcePrefix(osType, arch, name, isSoftFloat());
    }
    
    static String getNativeLibraryResourcePrefix(final int osType, String arch, final String name, final boolean isSoftfloat) {
